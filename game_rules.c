...
void displayRules() {
    ...
    fprintf(file, "            <p>There are 20 levels on Easy Mode and the word length ranges between 4 and 5 letters. The 8 lives rule is applicable. If you finish with one of the top scores, it will be added to our Leaderboard!</p>\n");
    fprintf(file, "        </div>\n");
    fprintf(file, "\n");
    fprintf(file, "        <button class=\"accordion\">Medium Mode</button>\n");
    fprintf(file, "        <div class=\"panel\">\n");
    fprintf(file, "            <p>There are 20 levels on Medium Mode and the word length ranges between 4 and 6 letters. The 8 lives rule is applicable. If you finish with one of the top scores, it will be added to our Leaderboard!.</p>\n");
    fprintf(file, "        </div>\n");
    fprintf(file, "\n");
    fprintf(file, "        <button class=\"accordion\">Hard Mode</button>\n");
    fprintf(file, "        <div class=\"panel\">\n");
    fprintf(file, "            <p>There are 20 levels on Hard Mode and the word length ranges between 6 and 7 letters. The 8 lives rule is applicable. Each time you guess wrongly, you lose 1 point. If you manage to guess the word with 120 seconds (2 minutes), you earn an extra point. If you finish with one of the top scores, it will be added to our Leaderboard!</p>\n");
    fprintf(file, "        </div>\n");
    fprintf(file, "\n");
